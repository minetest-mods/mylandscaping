...
{"Left", 		"left", 	"block1_top_l",		colbox_type1, "left"},
{"Middle", 		"middle",	"block1_top_m",		colbox_type1, "middle"},
{"Right", 		"right",	"block1_top_r",		colbox_type1, "right"},
{"Corner", 		"corner",	"block1_top_c",		colbox_type4, "corner"},
{"Column Top", 		"column",	"column_upper",		colbox_type2, "column"},

{"Left Bot", 		"bleft", 	"block1_bot_l",		colbox_type3, "left"},
{"Middle Bot", 		"bmiddle",	"block1_bot_m",		colbox_type3, "middle"},
{"Right Bot", 		"bright",	"block1_bot_r",		colbox_type3, "right"},
{"Corner Bot", 		"bcorner",	"block1_bot_c",		colbox_type4, "corner"},
{"Column Bot", 		"bcolumn",	"column_lower",		colbox_type2, "column"},
}
